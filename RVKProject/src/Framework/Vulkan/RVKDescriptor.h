...
namespace RVK {
    ...
    public:
        ...
        RVKDescriptorPool(u32 maxSets, VkDescriptorPoolCreateFlags poolFlags, const std::vector<VkDescriptorPoolSize>& poolSizes);
        ~RVKDescriptorPool();
    ...
    public:
        ...
        RVKDescriptorWriter& WriteBuffer(u32 binding, const VkDescriptorBufferInfo& bufferInfo);
        RVKDescriptorWriter& WriteImage(u32 binding, const VkDescriptorImageInfo& imageInfo);
